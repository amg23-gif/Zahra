...
export const SURAHS: Surah[] = [
  ...
  { number: 26, name: 'الشعراء', englishName: 'Ash-Shuara', versesCount: 227, revelationType: 'Meccan' },
  ...
  { number: 74, name: 'المدثر', englishName: 'Al-Muddaththir', versesCount: 56, revelationType: 'Meccan' },
